  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return _buildInteractiveGrid(savedArticles, context);
      },
    );
  }
                ...
                const PopupMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text('Unsave', style: TextStyle(fontFamily: 'Poppins', color: Colors.orange)),
                    ],
                  ),
                ),
                const PopupMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text('Like', style: TextStyle(fontFamily: 'Poppins', color: Colors.red)),
                    ],
                  ),
                ),
              ],
  ...
  void _handleMenuAction(String action, NewsArticle article, BuildContext context) {
    switch (action) {
      ...
      case 'like':
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Added to liked posts')),
        );
        break;
    }
  }
